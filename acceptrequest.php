          ...
          <div class="main-nav d-none d-lg-block">
            <nav class="site-navigation text-right text-md-center" role="navigation">
              <ul class="site-menu js-clone-nav d-none d-lg-block">
                ...
                <li class="active"><a href="register.html">Accept Request</a></li>
              </ul>
            </nav>
        </div>
      </div>
    ...
    <div style="margin-left:30%;">
		<div class="site-section">
		  <div class="container">
			<div class="row">
			  <div class="col-md-12">
				<h2 class="h3 mb-5 text-black">Accept donation request</h2>
			  </div>
			  <div class="col-md-12">
				...
				<form action="adddonor.php" method="POST">
				  ...
				  <div class="p-3 p-lg-5 border">
					<div class="form-group row">
					  <div class="col-md-12">
						<label for="fname" class="text-black">Donation ID <span class="text-danger">*</span></label>
						<input type="text" class="form-control" id="id" name="id">
					  </div>
					</div>
					<div class="form-group row">
					  <div class="col-md-12">
						<label for="fname" class="text-black">Name <span class="text-danger">*</span></label>
					...
					<div class="form-group row">
					  <div class="col-md-12">
						<label for="dob" class="text-black">Ready to Donate? <span class="text-danger">*</span></label><br>
					...
					<div class="form-group row">
					  <div class="col-md-12">
						<label for="age" class="text-black">Your estimated time to reach the destination in minutes <span class="text-danger">*</span></label>
